...
try {
    const user = new SayaTubeUser("Wielino INO");

    const video1 = new SayaTubeVideo("Basreng Doa Ibu");
    const video2 = new SayaTubeVideo("Unsub Ace Anthem");
    const video3 = new SayaTubeVideo("Epen maling rendang willi salim");
